...
namespace NodeLib.Test
{
    ...
    {
        [TestMethod]
        public void TestCliqueEnsembleCpu()
        {
        ...
        [TestMethod]
        public void TestCliqueEnsembleIterationsCpu()
        {
            const int ensembleCount = 10;
            const int nodeCount = 5;
            const int seed = 145;
        ...
        [TestMethod]
        public void TestCliqueEnsembleGpu()
        {
            const int ensembleCount = 10;
            const int nodeCount = 5;
            const int seed = 145;
        ...
        [TestMethod]
        public void TestCliqueEnsembleIterationsGpu()
        {
            const int ensembleCount = 10;
            const int nodeCount = 5;
            const int seed = 145;
